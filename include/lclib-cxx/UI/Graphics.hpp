...
namespace graphics{
	...
	public:
		 ...
		 */
		virtual std::shared_ptr<GraphicsContext> newWindowContext(const Rectangle&)volatile=0;
		/**
		 ...
		 */
		virtual bool supportsUndecorated(const std::shared_ptr<GraphicsContext>&)const volatile=0;
		/**
		 ...
		 */
		virtual bool supportsUndecorated()const volatile=0;
		/**
		 ...
		 */
		virtual void setUndecorated(const std::shared_ptr<GraphicsContext>&,bool)volatile=0;
		/**
		 ...
		 */
		virtual bool supportsRGB()const volatile=0;
		/**
		 ...
		 */
		virtual const Rectangle& getEnvironmentSize()const volatile=0;
		/**
		 ...
		 * If the toolkit is headless, throws a HeadlessException.
		 */
		virtual std::size_t getDesktopCount()const volatile=0;
		/**
		 ...
		 */
		virtual std::shared_ptr<GraphicsContext> getEnvironment()const volatile=0;
		/**
		 ...
		 */
		virtual std::shared_ptr<GraphicsContext> getDesktopEnvironment(std::size_t n)const volatile=0 EXPECTS(n<getDesktopCount());
	};
	/**
	...
	public:
		 ...
		 */
		virtual volatile Toolkit& getToolkit()const=0;
	};
	volatile Toolkit& getDefaultToolkit();
	class Graphics{
	private:
	...
	public:
		Graphics();
		Graphics(std::shared_ptr<GraphicsContext>,const Rectangle&)const;
		Graphics getSubregion(const Rectangle&)const;
		const Rectangle& getRegion()const;
		void resizeAndMove(const Rectangle&)const;
		void draw(const Shape&,Color)const;
		void draw(const Shape&,Image)const;
	};
}
