...
#include <Text.hpp>//For TGI Color
#include <cstddef>
#include <cstdint>
#include <Config.hpp>
#include <type_traits>
...
using TGIColor = ::Color;
	...
	*/
	...
	public:
		...
		constexpr rgb_type toRGB(value_type r){
			return r;
		}
		constexpr value_type fromRGB(rgb_type r){
			return r;
		}
	};
}
...
namespace types{
	template<> struct TypeHash<graphics::Color>{
		...
		constexpr TypeCode operator()()const noexcept(true){
			return nameHash("graphics::Color");
		}
	};
}
